...
export const VERSION_HISTORY = [
  ...
  },
  {
    ...
    date: '2026-09-03',
    highlights: [
      '🔎 Searching the component library (sidebar or ⌘/Ctrl+K Quick Actions) for an exact or near-exact product name — e.g. "Redis", "Device", "React" — now surfaces that component first, ahead of an alphabetically-earlier component that only mentions the term in its description or shares some of the same letters (e.g. "React" no longer gets buried behind "Preact").',
      '🖥️ Presenter Mode and Diagram Animation playback now also hide the floating style/arrow editor if something was still selected when you entered — previously it stayed on top of the presentation.',
      '📱 On mobile-width screens, opening the details/AI-review/AI-chat/outline/animation panel while a component or connector is selected now hides that same floating editor instead of leaving it overlapping the panel.',
    ],
  },
  {
    version: '1.58.3',
  ...
  },
  {
    ...
    date: '2026-09-03',
    highlights: [
      '🔀 Adding a suggested flow diagram to a component ("+ Add" in the details panel, or the placement-time suggestion banner) now attaches it as a small collapsed indicator on that component instead of a full-size diagram appearing next to it — click its 🔍 to view the flow full size.',
      '📦 "Group & Shrink" placeholders now show a small live preview of the grouped components\' own icons/colors, scaled down together, instead of looking like an unrelated blank component.',
      '🔗 The right-click menu on a multi-selection now offers a plain "Group" item (group without collapsing), alongside "Group & Shrink" — previously only reachable from the toolbar\'s contextual style row.',
    ],
  },
  {
    version: '1.58.0',
  ...
  },
  {
    ...
    highlights: [
      ...
      '🎬 New "Camera Tour" in 3D Presentation Mode (both the default view and Realistic Room) — capture the current camera angle as a named shot ("📍 Add Current View"), reorder or remove shots, or generate a full tour automatically ("✨ Auto-Generate": one shot per component plus a closing overview). "▶️ Play Tour" smoothly glides between shots with an optional loop; dragging or scrolling the camera at any point hands control straight back to you. "🎥 Export 3D Video" now drives its recording from a configured tour instead of just a slow ambient spin (and this now explicitly works in Realistic Room mode too), and a new "📊 Export 3D Presentation" button exports a real .pptx with one slide per tour shot (or Diagram Animation step, if no tour is set).',
    ],
  },
  {
    version: '1.49.3',
