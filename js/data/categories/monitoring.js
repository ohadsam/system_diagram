...
export const components = [
  ...
  c('mon-grafana', 'Grafana', '📊', { popular: true, color: '#F46800', related: ['mon-prometheus', 'log-loki'] }),
  ...
  c('mon-prometheus', 'Prometheus', '🔥', { popular: true, color: '#E6522C', related: ['mon-grafana'] }),
