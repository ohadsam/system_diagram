...
export const components = [
  c('net-api-gateway', 'API Gateway', '🚪', { popular: true, color: NW, related: ['srv-app-server', 'misc-graphql', 'sec-oauth'], relatedLayers: ['layer-authentication', 'layer-rate-limiter'] }),
