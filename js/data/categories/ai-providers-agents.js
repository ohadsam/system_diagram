...
export const components = [
  // Providers
  c('ai-provider-anthropic', 'Anthropic (Claude)', '🟠', { color: AI, tags: ['provider', 'llm'], description: 'Anthropic API — Claude models.' }),
  ...
  c('ai-provider-azure-openai', 'Azure OpenAI Service', '🔷', { color: AI, tags: ['provider', 'azure', 'llm'] }),
  c('ai-provider-cohere', 'Cohere', '🟣', { color: AI, tags: ['provider', 'llm', 'embeddings'] }),
  c('ai-provider-deepseek', 'DeepSeek', '🔍', { color: AI, tags: ['provider', 'llm'] }),
  c('ai-provider-google', 'Google AI (Gemini)', '🔵', { color: AI, tags: ['provider', 'llm'] }),
  ...
  c('ai-provider-meta', 'Meta AI (Llama)', '♾️', { color: AI, tags: ['provider', 'llm'] }),
  c('ai-provider-mistral', 'Mistral AI', '🌬️', { color: AI, tags: ['provider', 'llm'] }),
  ...
  c('ai-provider-openai', 'OpenAI', '🤖', { color: AI, tags: ['provider', 'llm'], description: 'OpenAI API — GPT models.' }),
  ...
  c('ai-provider-stabilityai', 'Stability AI', '🎨', { color: AI, tags: ['provider', 'image-generation'] }),
  c('ai-provider-togetherai', 'Together AI', '🤝', { color: AI, tags: ['provider', 'inference', 'llm'] }),
  c('ai-provider-xai', 'xAI (Grok)', '✖️', { color: AI, tags: ['provider', 'llm'] }),

  // Models
  c('ai-model-claude', 'Claude Model', '🎭', { color: AI, tags: ['model', 'llm'] }),
  c('ai-model-dalle', 'DALL·E (Image Generation)', '🖼️', { color: AI, tags: ['model', 'image-generation'] }),
  c('ai-model-deepseek', 'DeepSeek Model', '🔍', { color: AI, tags: ['model', 'llm'] }),
  c('ai-model-gemini', 'Gemini Model', '♊', { color: AI, tags: ['model', 'llm', 'multimodal'] }),
  c('ai-model-gpt', 'GPT Model', '🧠', { color: AI, tags: ['model', 'llm'] }),
  c('ai-model-grok', 'Grok Model', '✖️', { color: AI, tags: ['model', 'llm'] }),
  c('ai-model-llama', 'Llama Model', '🦙', { color: AI, tags: ['model', 'llm', 'open-source'] }),
  c('ai-model-mistral', 'Mistral Model', '🌬️', { color: AI, tags: ['model', 'llm', 'open-source'] }),
  ...
  c('ai-model-stable-diffusion', 'Stable Diffusion', '🎨', { color: AI, tags: ['model', 'image-generation'] }),
  c('ai-model-whisper', 'Whisper (Speech-to-Text)', '🎙️', { color: AI, tags: ['model', 'speech'] }),

  // MCP (Model Context Protocol)
  c('ai-mcp-client', 'MCP Client', '🔗', { color: AI, tags: ['mcp', 'protocol'], description: 'Connects an AI app/agent to MCP servers.' }),
  c('ai-mcp-prompt', 'MCP Prompt', '📝', { color: AI, tags: ['mcp', 'protocol'] }),
  c('ai-mcp-resource', 'MCP Resource', '📂', { color: AI, tags: ['mcp', 'protocol'] }),
  c('ai-mcp-server', 'MCP Server', '🔌', { color: AI, tags: ['mcp', 'protocol'], description: 'Exposes tools/resources/prompts to AI clients over MCP.' }),
  c('ai-mcp-tool', 'MCP Tool', '🛠️', { color: AI, tags: ['mcp', 'protocol', 'tool-calling'] }),

  // Agents & agent frameworks
  c('ai-agent', 'AI Agent', '🤖', { color: AI, tags: ['agent'], description: 'An LLM-driven actor that plans and takes actions.' }),
  c('ai-agent-memory', 'Agent Memory', '🧠', { color: AI, tags: ['agent', 'state'] }),
  c('ai-agent-orchestrator', 'Multi-Agent Orchestrator', '🎼', { color: AI, tags: ['agent', 'orchestration'] }),
  c('ai-agent-planner', 'Agent Planner', '🗺️', { color: AI, tags: ['agent', 'planning'] }),
  ...
  c('ai-framework-llamaindex', 'LlamaIndex', '🦙', { color: AI, tags: ['agent-framework', 'rag'] }),
  c('ai-framework-semantic-kernel', 'Semantic Kernel', '🧿', { color: AI, tags: ['agent-framework'] }),
  c('ai-subagent', 'Sub-Agent', '🧬', { color: AI, tags: ['agent'] }),
  ...
  c('ai-knowledge-base', 'Knowledge Base', '📖', { shape: 'cylinder', color: AI, tags: ['rag', 'storage'] }),
  c('ai-prompt-template', 'Prompt Template', '📝', { color: AI, tags: ['prompt'] }),
  c('ai-rag-pipeline', 'RAG Pipeline', '🔍', { color: AI, tags: ['rag', 'retrieval'], description: 'Retrieval-Augmented Generation pipeline.' }),
  c('ai-reranker', 'Reranker', '📶', { color: AI, tags: ['rag', 'retrieval'] }),
