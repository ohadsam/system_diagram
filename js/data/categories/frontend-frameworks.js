...
export const components = [
  ...
  c('fe-nextjs', 'Next.js', '▲', { color: '#111827', related: ['fe-react', 'cloud-vercel'] }),
  c('fe-nuxt', 'Nuxt', '💚', { color: '#00DC82', related: ['fe-vue'] }),
  c('fe-preact', 'Preact', '💠', { color: '#673AB8' }),
  c('fe-qwik', 'Qwik', '⚡', { color: '#AC7EF4' }),
  c('fe-react', 'React', '⚛️', { color: '#61DAFB', related: ['fe-nextjs'], relatedLayers: ['layer-react-hook', 'layer-react-component'] }),
  c('fe-remix', 'Remix', '💿', { color: FE, related: ['fe-react'] }),
  c('fe-solidjs', 'SolidJS', '🔷', { color: '#2C4F7C' }),
  c('fe-svelte', 'Svelte', '🔥', { color: '#FF3E00' }),
  c('fe-vue', 'Vue.js', '💚', { color: '#42B883', related: ['fe-nuxt'], relatedLayers: ['layer-vue-component', 'layer-vue-store'] }),
];
