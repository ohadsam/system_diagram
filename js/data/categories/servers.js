...
export const components = [
  ...
  c('srv-microservice', 'Microservice', '🧩', { color: SV, related: ['net-service-mesh'], relatedLayers: ['layer-controller', 'layer-service'] }),
  ...
  c('srv-serverless-fn', 'Serverless Function', 'ƒ', { color: SV, related: ['net-api-gateway'], relatedLayers: ['layer-handler'] }),
