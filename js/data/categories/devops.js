...
export const components = [
  ...
  c('devops-argocd', 'ArgoCD', '🐙', { color: '#EF7B4D', related: ['ctr-kubernetes'] }),
  ...
  c('devops-github-actions', 'GitHub Actions', '🐙', { popular: true, color: '#24292E' }),
  c('devops-gitlab-ci', 'GitLab CI', '🦊', { color: '#FC6D26' }),
  c('devops-jenkins', 'Jenkins', '🎩', { popular: true, color: '#D24939', related: ['ctr-docker'] }),
  c('devops-puppet', 'Puppet', '🎎', { color: '#FFAE1A' }),
  c('devops-spinnaker', 'Spinnaker', '❄️', { color: '#139BB4', related: ['ctr-kubernetes'], relatedPatterns: ['seq-canary-deployment'] }),
