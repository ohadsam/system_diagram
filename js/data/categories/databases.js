...
export const components = [
  ...
  c('db-elasticsearch', 'Elasticsearch', '🔎', { ...CYL, color: '#005571', tags: ['search', 'nosql'] }),
  ...
  c('db-mongodb', 'MongoDB', '🍃', { ...CYL, color: '#47A248', tags: ['nosql', 'document'] }),
  c('db-mysql', 'MySQL', '🐬', { ...CYL, color: '#4479A1', tags: ['sql'] }),
  ...
  c('db-postgres', 'PostgreSQL', '🐘', { ...CYL, color: '#336791', tags: ['sql'] }),
  c('db-redis', 'Redis', '🧵', { ...CYL, color: '#DC382D', tags: ['nosql', 'key-value', 'cache'] }),
