...
export const components = [
  ...
  c('db-mongodb', 'MongoDB', '🍃', { popular: true, ...CYL, color: '#47A248', tags: ['nosql', 'document'], related: ['db-redis'] }),
  c('db-mysql', 'MySQL', '🐬', { popular: true, ...CYL, color: '#4479A1', tags: ['sql'], related: ['db-redis'] }),
  ...
  c('db-postgres', 'PostgreSQL', '🐘', { popular: true, ...CYL, color: '#336791', tags: ['sql'], related: ['db-redis'] }),
  c('db-redis', 'Redis', '🧵', { popular: true, ...CYL, color: '#DC382D', tags: ['nosql', 'key-value', 'cache'], related: ['db-postgres', 'db-mysql', 'db-mongodb'] }),
