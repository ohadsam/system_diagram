...
export const components = [
  ...
  c('sec-api-key', 'API Key', '🗝️', { color: SEC, relatedPatterns: ['seq-api-key-auth', 'seq-idempotency-key'] }),
  ...
  c('sec-sso', 'Single Sign-On (SSO)', '🔑', { color: SEC, relatedPatterns: ['seq-sso-saml', 'seq-webauthn-passkey'] }),
