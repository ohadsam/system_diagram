...
export const components = [
  ...
  c('be-django', 'Django (Python)', '🐍', { color: '#092E20' }),
  c('be-dotnet', '.NET / C#', '🔷', { color: '#512BD4' }),
  c('be-express', 'Express (Node.js)', '🚂', { color: '#111827' }),
  ...
  c('be-nestjs', 'NestJS (Node.js)', '🐈', { color: '#E0234E' }),
  c('be-nodejs', 'Node.js', '🟢', { color: '#339933' }),
  c('be-phoenix', 'Phoenix (Elixir)', '🔥', { color: '#FD4F00' }),
  c('be-python', 'Python', '🐍', { color: '#3776AB' }),
  c('be-rails', 'Ruby on Rails', '💎', { color: '#CC0000' }),
  c('be-spring-boot', 'Spring Boot (Java)', '🍃', { color: '#6DB33F' }),
];
